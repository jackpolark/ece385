...
#
# Generated by export_simulation on Thu May 08 23:48:31 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './dog_rom.sh' script.

./dog_rom.sh -reset_run
...
./dog_rom.sh -noclean_files

For more information on the script, please type './dog_rom.sh -help'.

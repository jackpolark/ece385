...
HD_PWD='C:/Users/jacka/finalproj_try1/finalproj_try1.runs/duckhunt_sprite_dog_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log duckhunt_sprite_dog_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source duckhunt_sprite_dog_rom.tcl

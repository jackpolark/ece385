...
HD_PWD='C:/Users/erinm/Vivado_projects/ECE385-Work/final/proj_jack_4_23/finalproj_try1/finalproj_try1.runs/ducks_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ducks_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ducks_rom.tcl

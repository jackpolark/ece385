...
#
# Generated by export_simulation on Fri Apr 25 13:36:33 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './ducks_rom.sh' script.

./ducks_rom.sh -reset_run
...
./ducks_rom.sh -noclean_files

For more information on the script, please type './ducks_rom.sh -help'.

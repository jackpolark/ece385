...
#
# Generated by export_simulation on Fri May 09 03:58:52 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './info_rom.sh' script.

./info_rom.sh -reset_run
...
./info_rom.sh -noclean_files

For more information on the script, please type './info_rom.sh -help'.

...
#
# Generated by Vivado on Tue Apr 08 22:05:30 -0500 2025
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../hdmi_text_controller_2_0/src/clk_wiz_0_1/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../hdmi_text_controller_2_0/src/clk_wiz_0_1/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log

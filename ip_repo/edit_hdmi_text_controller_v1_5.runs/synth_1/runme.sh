...
HD_PWD='c:/users/jacka/ip_repo/edit_hdmi_text_controller_v1_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_text_controller_v1_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_text_controller_v1_5.tcl
